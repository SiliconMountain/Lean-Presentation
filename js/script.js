$(function() {
	...
	window.addEventListener('impress:stepenter', function() {
	  $('#what_content.active span.salmon').addClass('animated tada');
	});
	window.addEventListener('impress:stepenter', function() {
	  $('#what_content.past span.salmon').removeClass('animated tada');
	});
	window.addEventListener('impress:stepenter', function() {
	  $('#what_content.future span.salmon').removeClass('animated tada');
	});
	...
	window.addEventListener('impress:stepenter', function() {
	  $('#quality.animar.active ul li').addClass('animated bounceIn');
	});
	window.addEventListener('impress:stepenter', function() {
	  $('#quality.animar.past ul li').removeClass('animated bounceIn');
	});
	window.addEventListener('impress:stepenter', function() {
	  $('#quality.animar.future ul li').removeClass('animated bounceIn');
	});
	...
	$('.bml').css('opacity',0);
	window.addEventListener('impress:stepenter', function() {
	  $('.bml.active').animate({'opacity': 1});
	});
	window.addEventListener('impress:stepleave', function() {
	  $('.bml.past').animate({'opacity': 0});
	});

	$('.jargon').css('opacity',0);
	window.addEventListener('impress:stepenter', function() {
	  $('.jargon.active').animate({'opacity': 1});
	});
	window.addEventListener('impress:stepleave', function() {
	  $('.jargon.past').animate({'opacity': 0});
	});

//lines

	window.addEventListener('impress:stepenter', function() {
	  $('#do_it_2.active p.upLine').addClass('animated bounceInDown');
	});
	window.addEventListener('impress:stepenter', function() {
	  $('#do_it_2.past p.upLine').removeClass('animated bounceInDown');
	});
	window.addEventListener('impress:stepenter', function() {
	  $('#do_it_2.future p.upLine').removeClass('animated bounceInDown');
	});

	window.addEventListener('impress:stepenter', function() {
	  $('#do_it_2.active p.downLine').addClass('animated bounceInUp');
	});
	window.addEventListener('impress:stepenter', function() {
	  $('#do_it_2.past p.downLine').removeClass('animated bounceInUp');
	});
	window.addEventListener('impress:stepenter', function() {
	  $('#do_it_2.future p.downLine').removeClass('animated bounceInUp');
	});
